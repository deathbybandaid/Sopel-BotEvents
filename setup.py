...
setup(
    name='sopel_modules.botevents',
    version='0.1.0',
    description='Sopel BotEvents is a poor mans way to create module load order dependencies',
    long_description=readme + '\n\n' + history,
    author='Sam Zick',
    author_email='sam@deathbybandaid.net',
    url='https://github.com/deathbybandaid/Sopel-BotEvents',
